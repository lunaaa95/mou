...
if __name__ == '__main__':
    ...
    parser.add_argument('--topk', type=int, default=2, help='topk experts')
    ...
    parser.add_argument('--dps', type=float, nargs='+', default=[0.2, 0.2, 0.2, 0.0, 0.2], help='dropout list for encoder')
    ...
    # mamba
    parser.add_argument('--d_state', type=int, default=21, help="d_state of mamaba")
    # ffn
